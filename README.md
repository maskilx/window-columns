...
<p align="center">
  <a href="https://github.com/maskilx/window-columns/releases/download/v0.1.0-beta.5/Window-Columns-v0.1.0-beta.5-macos-arm64.zip">
...
> **Public beta:** the current source release is **0.1.0-beta.5**. It is built
...
`Window-Columns-v0.1.0-beta.5-macos-arm64.zip` from the
[v0.1.0-beta.5 prerelease](https://github.com/maskilx/window-columns/releases/tag/v0.1.0-beta.5),
