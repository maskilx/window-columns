...
This beta is distributed as source. There is no signed and notarised binary
download yet; only run code built from a revision you trust.
...
- **Not notarised.** This builds and runs locally under your own signing
  identity. Distributing a binary to other people would need a Developer ID
